...
TEST(LinearModelTest, CalculatesCorrectValue) {
    double result = linearModel(20.0, 10.0, 0.8, 0.001);
    EXPECT_NEAR(result, 16.01, 0.0001);
}
...
TEST(NonlinearModelTest, CalculatesCorrectValue) {
    double result = nonlinearModel(20.0, 20.0, 10.0, 10.0, 0.8, 0.001, 0.12, 0.05);
    double expected = 0.8 * 20.0 - 0.001 * 20.0 * 20.0 + 0.12 * 10.0 + 0.05 * std::sin(10.0);
